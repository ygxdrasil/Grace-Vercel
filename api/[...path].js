...
init_config();
init_modes();
var WATCHING = config.deployed ? "you check roughly once an hour while you are open somewhere, such as the laptop that stays on in their room, not from some place outside it." : "you check roughly once an hour for as long as you are running on their computer, whether or not anyone has you open, and anything that changed is written in your log and sent to their phone if it is set up.";
